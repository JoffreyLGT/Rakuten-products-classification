...
class StemmedCountVectorizer(CountVectorizer):
    ...
    def build_analyzer(self):
        ...
        return lambda doc: (StemmedCountVectorizer.fr_stemmer.stem(w) for w in analyzer(doc))
...
class StemmedTfidfVectorizer(TfidfVectorizer):
    ...
    def build_analyzer(self):
        ...
        return lambda doc: (StemmedTfidfVectorizer.fr_stemmer.stem(w) for w in analyzer(doc))
